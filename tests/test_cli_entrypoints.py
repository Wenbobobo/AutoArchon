...
def test_pyproject_declares_core_autoarchon_entrypoints():
    ...
    assert {
        ...
        "autoarchon-materialize-markdown-problem-pack",
        ...
        "autoarchon-helper-analysis",
        "autoarchon-helper-healthcheck",
...
def test_uv_run_help_smokes_for_core_entrypoints():
    commands = [
        ...
        ("autoarchon-helper-analysis", "campaign-root"),
        ("autoarchon-helper-healthcheck", "env-file"),
        ...
        ("autoarchon-materialize-markdown-problem-pack", "questions-markdown"),
